...
const GoogleLoginButton = () => {
	const handleGoogleLogin = () => {
	  const API_URL = import.meta.env.VITE_API_URL || "https://kapusta-backend.goit.global";
	  window.location.href = `${API_URL}/auth/google`;
	};
  
	return (
	  <button className="login__google-btn" type="button" onClick={handleGoogleLogin}>
  ...
  <main className="login-page container">
    ...
    <section className="login" aria-label="Login or Register to Kapusta">
      <div className="login__wrapper">
        ...
        <GoogleLoginButton />
        <p className="login__option-2">Or use your email and password:</p>
        <LoginForm />
      </div>
    </section>
  </main>
