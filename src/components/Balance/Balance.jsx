...
//     const [loading, setLoading] = useState(false); // Stan do śledzenia ładowania
...
//                     <div className="balance__input-wrapper">
//                         {loading ? (
//                             <div className="balance__spinner"></div> // Spinner zamiast pola
//                         ) : (
//                             <input
...
//                         }`}
//                         disabled={loading} // Zablokowanie przycisku podczas ładowania
//                     >
//                         CONFIRM
//                     </button>
//                 </div>
